...
class CountryStateCityPicker extends StatefulWidget {
  ...
  const CountryStateCityPicker(
      ...
      this.dialogColor,this.isShowCity,this.isShowCountry,this.isShowState});
